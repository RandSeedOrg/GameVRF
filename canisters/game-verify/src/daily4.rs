...
#[query]
fn generate_daily4_ball_by_hex_seeds(seed1: HexString, seed2: HexString, seed3: HexString, seed4: HexString) -> Result<Vec<u8>, String> {
  ...
  Ok(game_algorithms::daily4::generate_daily4_balls(seed1, seed2, seed3, seed4))
}

/// Generate Daily4 balls based on four byte-array seeds
#[query]
fn generate_daily4_balls(seed1: [u8; 32], seed2: [u8; 32], seed3: [u8; 32], seed4: [u8; 32]) -> Vec<u8> {
  game_algorithms::daily4::generate_daily4_balls(seed1, seed2, seed3, seed4)
}